import {HIDDEN_CLASS} from './subs-ui';

export function vidQuery() {
    return [
...
export function sectionTitleQuery() {
    return '#title';
}

export function sectionDismissableQuery() {
    return '#dismissible';
}

export function sectionContentsQuery() {
    return '#contents';
}
